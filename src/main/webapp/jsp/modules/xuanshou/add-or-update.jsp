            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑人员表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">人员表信息</h3>
...
<script>
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("xuanshou/" + urlParam, "POST", data, (res) => {
                if(res.code == 0
        )
            {
    ...
    function initializationXstypesSelect(){
        var xsTypesSelect = document.getElementById('xsTypesSelect');
            for (var i = 0; i < xsTypesOptions.length; i++) {
                xsTypesSelect.add(new Option(xsTypesOptions[i].indexName,xsTypesOptions[i].codeIndex));
            }
    }
    ...
    function dataBind() {
        ...
        $("#dateofbirthTime").val(ruleForm.dateofbirthTime);
        $("#information").val(ruleForm.information);
        $("#grinformation").val(ruleForm.grinformation);

            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">人员表登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="dateofbirthTime" name="dateofbirthTime" class="form-control"
                                               v-model="ruleForm.dateofbirthTime" readonly>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>家庭住址</label>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="information" name="information" class="form-control"
                                               v-model="ruleForm.information" readonly>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>个人联系方式</label>

                                        <input id="grinformation" name="grinformation" class="form-control"
                                               v-model="ruleForm.grinformation" readonly>
                                    </div>
                                <div class="form-group col-md-6">
                                    <label>
                                        性别

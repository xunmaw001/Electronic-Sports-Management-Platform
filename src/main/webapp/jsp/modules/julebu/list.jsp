    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">俱乐部表管理</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">俱乐部表管理</li>
                        <li class="breadcrumb-item active">俱乐部表列表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">俱乐部表列表</h3>
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                                                 
                                        <label>
                                            <input type="text" id="nameSearch" class="form-control form-control-sm"
                                                   placeholder="俱乐部名称" aria-controls="tableId">
                                        </label>
...
<script>
    ...
    function remove(id) {
        ...
        if (mymessage == true) {
            ...
            httpJson("julebu/delete", "POST", paramArray, (res) => {
                if(res.code == 0
        )
            {
                getDataList();
    ...
    function crossTable(id, crossTableName) {
        ...
        window.sessionStorage.setItem('crossTableName', "julebu");

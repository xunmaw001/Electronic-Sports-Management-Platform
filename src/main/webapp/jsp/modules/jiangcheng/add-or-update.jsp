            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑奖惩表</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            <div class="form-row">
                                   ...
                                   <div class="form-group col-md-6">
                                       <label>奖惩状态</label>
                                       <select id="jcTypesSelect" name="jcTypes" class="form-control">
                                       </select>
                                   </div>
                                   <div class="form-group col-md-6">
                                       <label>奖惩等级</label>
                                       <select id="djTypesSelect" name="djTypes" class="form-control">
                                       </select>
                                   </div>
...
<script>
    ...
    function initializationJctypesSelect(){
        var jcTypesSelect = document.getElementById('jcTypesSelect');
            for (var i = 0; i < jcTypesOptions.length; i++) {
                jcTypesSelect.add(new Option(jcTypesOptions[i].indexName,jcTypesOptions[i].codeIndex));
            }
    }
    function initializationDjtypesSelect(){
        var djTypesSelect = document.getElementById('djTypesSelect');
            for (var i = 0; i < djTypesOptions.length; i++) {
                djTypesSelect.add(new Option(djTypesOptions[i].indexName,djTypesOptions[i].codeIndex));
            }
    }
    // 下拉框选项回显
    function setSelectOption() {
        ...
        for (var i = 0; i < jcTypesOptions.length; i++) {
            if(jcTypesOptions[i].codeIndex == ruleForm.jcTypes){//下拉框value对比,如果一致就赋值汉字
                document.getElementById("jcTypesSelect").options[i].selected = true;
            }
        }
        for (var i = 0; i < djTypesOptions.length; i++) {
            if(djTypesOptions[i].codeIndex == ruleForm.djTypes){//下拉框value对比,如果一致就赋值汉字
                document.getElementById("djTypesSelect").options[i].selected = true;
            }
        }
    }
    ...
    function getDetails() {
        ...
        if (id != null && id != "" && id != "null") {
            updateId = id;
            window.sessionStorage.removeItem('updateId');
            http("jiangcheng/info/" + id, "GET", {}, (res) => {
                if(res.code == 0
        )
            {
                ruleForm = res.data
    ...
    function dataBind() {
        ...
        $("#headline").val(ruleForm.headline);
    ...
    $(document).ready(function () {
        ...
        initializationJctypesSelect();
        initializationDjtypesSelect();
        getDetails();
        //初始化上传按钮
        upload();
        //单列求和
